...
# def home(request):
#     """
#     This function is executed in the main page
#     """
#     boards = Board.objects.all()
#     return render(request, 'home.html', {'boards':boards})

# using Generic class based view `GCBV` alternative with `FBV'
...
def board_topics(request, board_id):
    ...
    #     raise Http404
    # This bleow line is equvialent to the above lines of code
...
def topic_posts(request, board_id, topic_id):
    ...
    session_key = 'view_toipc_{}'.format(topic.pk)
